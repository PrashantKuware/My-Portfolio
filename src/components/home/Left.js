...
const Left = () => {
  const [text] = useTypewriter({
    words: ["Web Developer", "Full Stack Developer","Data Structure & Algorithm"],
    loop: true,
    typeSpeed: 30,
    deleteSpeed: 20,
    delaySpeed: 2000,
        ...
        <div className="flex flex-col items-center gap-2 py-10">
          ...
          <div className="flex justify-center gap-2 mt-2">
            <span className="hover:text-designColor duration-300 cursor-pointer text-xl">
              <a
                href="https://github.com/PrashantKuware"
                target="_blank"
           ...
           <span className="hover:text-designColor duration-300 cursor-pointer text-xl">
              <a
                href="https://www.linkedin.com/in/prashant-kuware-855a0817b/"
                target="_blank"
                rel="noopener noreferrer"
              ><FaLinkedin />
              </a>
            ...
            <span className="hover:text-designColor duration-300 cursor-pointer text-xl">
              <a
                href="https://www.instagram.com/prashantkuware/?next=%2F"
                target="_blank"
                rel="noopener noreferrer"
              ><FiInstagram />
              </a>
